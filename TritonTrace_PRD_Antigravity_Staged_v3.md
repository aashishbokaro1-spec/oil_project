...
| Rank | MMSI | Vessel | Type | Flag | Distance | SOG Transit | SOG Origin | SOG Delta | Correlation | Assessment |
|---|---|---|---|---|---:|---:|---:|---:|---:|---|
...
An SOG anomaly row may show:

`SOG ANOMALY DETECTED`
...
export const mockAISVessels = [
  ...
  },
  {
    ...
    flag: "Malta",
    distance_to_origin_km: 22.8,
    sog_transit_knots: 13.6,
    sog_at_origin_knots: 13.5,
    cog_degrees: 60.0,
    sog_anomaly_flag: false,
    threat_score: 0.180,
    verdict: "LOW_CORRELATION"
...
export const mockHistoricalIncidents = [
  {
    id: "Sentinel ID: #042",
    coordinates: [14.6210, 36.1204],
    area_sqkm: 14.6,
    date: "2026-09-18",
    status: "Closed / Dossier Exported"
  },
  {
    id: "Sentinel ID: #089",
    coordinates: [14.3812, 35.7119],
    area_sqkm: 8.2,
    date: "2026-09-19",
    status: "Closed / Cleared"
  },
  {
    id: "Citizen Report: #112",
    coordinates: [14.2190, 35.6542],
    area_sqkm: 4.1,
    date: "2026-09-21",
